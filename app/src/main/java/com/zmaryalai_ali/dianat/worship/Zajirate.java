...
public class Zajirate extends Fragment {
    ...
    String stringarray[]={"jan","khan","afghan","ali","C++","java","OOP","Classes"};

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {

        rootview = inflater.inflate(R.layout.fragment_zajirate, container, false);
        expandableListView = rootview.findViewById(R.id.expandable);
        search=rootview.findViewById(R.id.search);
        ArrayAdapter arrayAdapter=new ArrayAdapter(context, R.layout.search_bar,R.id.tv_search,stringarray);
